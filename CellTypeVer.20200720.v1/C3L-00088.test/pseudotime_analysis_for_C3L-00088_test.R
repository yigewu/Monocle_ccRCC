...
setwd(dir_base)
path_srat <- "./Resources/Analysis_Results/integration/merge_same_patient_segments/merge_same_patient_segments_C3L-00088/20200707.v1/C3L-00088.Tumor_Segments.Merged.20200707.v1.RDS"
path_idmetadata <- "./Resources/Analysis_Results/sample_info/make_meta_data/20200505.v1/meta_data.20200505.v1.tsv"
path_bc2celltype <- "./Resources/Analysis_Results/annotate_barcode/map_celltype_to_all_cells_with_patch/20200707.v1/31AliquotIntegration.Barcode2CellType.TumorManualCluster.20200707.v1.tsv"
...
if (file.exists(obj_output_path) & opt$force.reprocess==FALSE){
  ...
  combined_subset <- subset(combined,cells=combined@meta.data %>% rownames_to_column %>% filter(Most_Enriched_Cell_Type1=="Proximal tubule") %>% .$rowname)
