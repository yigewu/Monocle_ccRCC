...
setwd(dir_base)
path_srat <- "./Resources/Analysis_Results/integration/merge_tumor_normal/merge_samples_with_normal_epithelial_cells_on_katmai/20200727.v1/Samples_with_NormalEpiCells.Merged.20200727.v1.RDS"
